...
import '../../../components/styles/PosterSection.css'; // Import styles
import '../../../components/styles/Responsive/PosterSection.responsive.css';
...
const PosterSection = () => {
  ...
  const handleBuyNowClick = (productId) => {
    navigate(`/preview-product/${productId}`); // Navigate to product page with product_id
  };
