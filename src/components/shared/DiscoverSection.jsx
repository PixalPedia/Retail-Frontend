...
import '../styles/DiscoverSection.css'; // Import styles specific to discover section
import '../styles/Responsive/DiscoverSection.responsive.css';
...
const DiscoverSection = () => {
  ...
  const handleCategoryClick = (categoryId) => {
    navigate(`/loadpage?category_id=${categoryId}`);
  };
